...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="G:/VIVADO/Vivado/2024.1/data/xsim"
  fi
...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib axi_lite_ipif_v3_0_4 v_tc_v6_2_0)
