...
module design_1_v_tpg_0_3_v_tpgHlsDataFlow (
        height_val4,
        width_val7,
        field_id_val8,
        fid_in_val9,
...
wire   [15:0] tpgBackground_U0_height_val4_c3_din;
wire    tpgBackground_U0_height_val4_c3_write;
wire   [15:0] tpgBackground_U0_width_val7_c4_din;
wire    tpgBackground_U0_width_val7_c4_write;
wire   [7:0] tpgBackground_U0_motionSpeed_val14_c_din;
wire    tpgBackground_U0_motionSpeed_val14_c_write;
wire   [7:0] tpgBackground_U0_colorFormat_val17_c5_din;
wire    tpgBackground_U0_colorFormat_val17_c5_write;
...
wire    colorFormat_val17_c5_full_n;
wire   [7:0] colorFormat_val17_c5_dout;
wire   [2:0] colorFormat_val17_c5_num_data_valid;
wire   [2:0] colorFormat_val17_c5_fifo_cap;
wire    colorFormat_val17_c5_empty_n;
...
design_1_v_tpg_0_3_entry_proc entry_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
design_1_v_tpg_0_3_tpgBackground tpgBackground_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
design_1_v_tpg_0_3_tpgForeground tpgForeground_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
design_1_v_tpg_0_3_MultiPixStream2AXIvideo MultiPixStream2AXIvideo_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
design_1_v_tpg_0_3_fifo_w16_d4_S field_id_val8_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_tpg_0_3_fifo_w1_d4_S fid_in_val9_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_tpg_0_3_fifo_w8_d3_S ovrlayId_val11_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_tpg_0_3_fifo_w8_d3_S maskId_val12_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_tpg_0_3_fifo_w16_d3_S crossHairX_val18_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_tpg_0_3_fifo_w16_d3_S crossHairY_val19_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_tpg_0_3_fifo_w16_d3_S boxSize_val24_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_tpg_0_3_fifo_w8_d3_S boxColorR_val25_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_tpg_0_3_fifo_w8_d3_S boxColorG_val26_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_tpg_0_3_fifo_w8_d3_S boxColorB_val27_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_tpg_0_3_fifo_w24_d16_S bckgndYUV_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_tpg_0_3_fifo_w16_d2_S height_val4_c3_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_tpg_0_3_fifo_w16_d2_S width_val7_c4_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_tpg_0_3_fifo_w8_d2_S motionSpeed_val14_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_tpg_0_3_fifo_w8_d2_S colorFormat_val17_c5_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_tpg_0_3_fifo_w24_d16_S ovrlayYUV_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_tpg_0_3_fifo_w12_d2_S height_val4_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_tpg_0_3_fifo_w13_d2_S width_val7_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_tpg_0_3_fifo_w8_d2_S colorFormat_val17_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_tpg_0_3_start_for_tpgForeground_U0 start_for_tpgForeground_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_tpg_0_3_start_for_MultiPixStream2AXIvideo_U0 start_for_MultiPixStream2AXIvideo_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
endmodule //design_1_v_tpg_0_3_v_tpgHlsDataFlow
