...
module design_1_v_tpg_0_3_entry_proc (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
reg    ap_block_state1;
reg    boxColorB_val27_c_write_local;
reg    boxColorG_val26_c_write_local;
reg    boxColorR_val25_c_write_local;
reg    boxSize_val24_c_write_local;
reg    crossHairY_val19_c_write_local;
reg    crossHairX_val18_c_write_local;
reg    maskId_val12_c_write_local;
reg    ovrlayId_val11_c_write_local;
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        boxColorB_val27_c_write_local = 1'b1;
    end else begin
        boxColorB_val27_c_write_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        boxColorG_val26_c_write_local = 1'b1;
    end else begin
        boxColorG_val26_c_write_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        boxColorR_val25_c_write_local = 1'b1;
    end else begin
        boxColorR_val25_c_write_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        boxSize_val24_c_write_local = 1'b1;
    end else begin
        boxSize_val24_c_write_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        crossHairX_val18_c_write_local = 1'b1;
    end else begin
        crossHairX_val18_c_write_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        crossHairY_val19_c_write_local = 1'b1;
    end else begin
        crossHairY_val19_c_write_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        maskId_val12_c_write_local = 1'b1;
    end else begin
        maskId_val12_c_write_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        ovrlayId_val11_c_write_local = 1'b1;
    end else begin
        ovrlayId_val11_c_write_local = 1'b0;
    end
end
...
assign boxColorB_val27_c_write = boxColorB_val27_c_write_local;

assign boxColorG_val26_c_din = boxColorG_val26;

assign boxColorG_val26_c_write = boxColorG_val26_c_write_local;

assign boxColorR_val25_c_din = boxColorR_val25;

assign boxColorR_val25_c_write = boxColorR_val25_c_write_local;

assign boxSize_val24_c_din = boxSize_val24;

assign boxSize_val24_c_write = boxSize_val24_c_write_local;

assign crossHairX_val18_c_din = crossHairX_val18;

assign crossHairX_val18_c_write = crossHairX_val18_c_write_local;

assign crossHairY_val19_c_din = crossHairY_val19;

assign crossHairY_val19_c_write = crossHairY_val19_c_write_local;
...
assign maskId_val12_c_write = maskId_val12_c_write_local;

assign ovrlayId_val11_c_din = ovrlayId_val11;

assign ovrlayId_val11_c_write = ovrlayId_val11_c_write_local;

assign start_out = real_start;

endmodule //design_1_v_tpg_0_3_entry_proc
