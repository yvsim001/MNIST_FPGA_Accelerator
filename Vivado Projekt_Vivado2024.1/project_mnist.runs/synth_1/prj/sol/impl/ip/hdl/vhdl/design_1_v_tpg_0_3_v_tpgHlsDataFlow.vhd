...
entity design_1_v_tpg_0_3_v_tpgHlsDataFlow is
port (
...
architecture behav of design_1_v_tpg_0_3_v_tpgHlsDataFlow is 
...
attribute shreg_extract : string;
    ...
    signal tpgBackground_U0_height_val4_c3_din : STD_LOGIC_VECTOR (15 downto 0);
    signal tpgBackground_U0_height_val4_c3_write : STD_LOGIC;
    signal tpgBackground_U0_width_val7_c4_din : STD_LOGIC_VECTOR (15 downto 0);
    signal tpgBackground_U0_width_val7_c4_write : STD_LOGIC;
    ...
    signal tpgBackground_U0_colorFormat_val17_c5_din : STD_LOGIC_VECTOR (7 downto 0);
    signal tpgBackground_U0_colorFormat_val17_c5_write : STD_LOGIC;
    ...
    signal colorFormat_val17_c5_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    component design_1_v_tpg_0_3_entry_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component design_1_v_tpg_0_3_tpgBackground IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component design_1_v_tpg_0_3_tpgForeground IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component design_1_v_tpg_0_3_MultiPixStream2AXIvideo IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component design_1_v_tpg_0_3_fifo_w16_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component design_1_v_tpg_0_3_fifo_w1_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_tpg_0_3_fifo_w8_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_tpg_0_3_fifo_w16_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_tpg_0_3_fifo_w24_d16_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_tpg_0_3_fifo_w16_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_tpg_0_3_fifo_w8_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_tpg_0_3_fifo_w12_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_tpg_0_3_fifo_w13_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_tpg_0_3_start_for_tpgForeground_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_tpg_0_3_start_for_MultiPixStream2AXIvideo_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc_U0 : component design_1_v_tpg_0_3_entry_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    tpgBackground_U0 : component design_1_v_tpg_0_3_tpgBackground
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        height_val4_c3_din => tpgBackground_U0_height_val4_c3_din,
        ...
        height_val4_c3_write => tpgBackground_U0_height_val4_c3_write,
        width_val7_c4_din => tpgBackground_U0_width_val7_c4_din,
        ...
        width_val7_c4_write => tpgBackground_U0_width_val7_c4_write,
        ...
        colorFormat_val17_c5_din => tpgBackground_U0_colorFormat_val17_c5_din,
        colorFormat_val17_c5_num_data_valid => colorFormat_val17_c5_num_data_valid,
        colorFormat_val17_c5_fifo_cap => colorFormat_val17_c5_fifo_cap,
        colorFormat_val17_c5_full_n => colorFormat_val17_c5_full_n,
        colorFormat_val17_c5_write => tpgBackground_U0_colorFormat_val17_c5_write,
        s => s);

    tpgForeground_U0 : component design_1_v_tpg_0_3_tpgForeground
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        colorFormat_val_dout => colorFormat_val17_c5_dout,
        colorFormat_val_num_data_valid => colorFormat_val17_c5_num_data_valid,
        colorFormat_val_fifo_cap => colorFormat_val17_c5_fifo_cap,
        colorFormat_val_empty_n => colorFormat_val17_c5_empty_n,
    ...
    MultiPixStream2AXIvideo_U0 : component design_1_v_tpg_0_3_MultiPixStream2AXIvideo
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    field_id_val8_c_U : component design_1_v_tpg_0_3_fifo_w16_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    fid_in_val9_c_U : component design_1_v_tpg_0_3_fifo_w1_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ovrlayId_val11_c_U : component design_1_v_tpg_0_3_fifo_w8_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    maskId_val12_c_U : component design_1_v_tpg_0_3_fifo_w8_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    crossHairX_val18_c_U : component design_1_v_tpg_0_3_fifo_w16_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    crossHairY_val19_c_U : component design_1_v_tpg_0_3_fifo_w16_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    boxSize_val24_c_U : component design_1_v_tpg_0_3_fifo_w16_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    boxColorR_val25_c_U : component design_1_v_tpg_0_3_fifo_w8_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    boxColorG_val26_c_U : component design_1_v_tpg_0_3_fifo_w8_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    boxColorB_val27_c_U : component design_1_v_tpg_0_3_fifo_w8_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    bckgndYUV_U : component design_1_v_tpg_0_3_fifo_w24_d16_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    height_val4_c3_U : component design_1_v_tpg_0_3_fifo_w16_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => tpgBackground_U0_height_val4_c3_din,
        if_full_n => height_val4_c3_full_n,
        if_write => tpgBackground_U0_height_val4_c3_write,
    ...
    width_val7_c4_U : component design_1_v_tpg_0_3_fifo_w16_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => tpgBackground_U0_width_val7_c4_din,
        if_full_n => width_val7_c4_full_n,
        if_write => tpgBackground_U0_width_val7_c4_write,
    ...
    motionSpeed_val14_c_U : component design_1_v_tpg_0_3_fifo_w8_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    colorFormat_val17_c5_U : component design_1_v_tpg_0_3_fifo_w8_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => tpgBackground_U0_colorFormat_val17_c5_din,
        if_full_n => colorFormat_val17_c5_full_n,
        if_write => tpgBackground_U0_colorFormat_val17_c5_write,
        if_dout => colorFormat_val17_c5_dout,
        if_num_data_valid => colorFormat_val17_c5_num_data_valid,
        if_fifo_cap => colorFormat_val17_c5_fifo_cap,
        if_empty_n => colorFormat_val17_c5_empty_n,
        if_read => tpgForeground_U0_colorFormat_val_read);

    ovrlayYUV_U : component design_1_v_tpg_0_3_fifo_w24_d16_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    height_val4_c_U : component design_1_v_tpg_0_3_fifo_w12_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    width_val7_c_U : component design_1_v_tpg_0_3_fifo_w13_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    colorFormat_val17_c_U : component design_1_v_tpg_0_3_fifo_w8_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_tpgForeground_U0_U : component design_1_v_tpg_0_3_start_for_tpgForeground_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_MultiPixStream2AXIvideo_U0_U : component design_1_v_tpg_0_3_start_for_MultiPixStream2AXIvideo_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
