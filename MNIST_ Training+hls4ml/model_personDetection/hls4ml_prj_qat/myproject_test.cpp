...
int main(int argc, char **argv) {
    ...
    if (fin.is_open() && fpr.is_open()) {
      ...
      hls::stream<input_t> img_input("img_input");
      nnet::copy_data<float, input_t, 0, N_INPUT_1_1*N_INPUT_2_1*N_INPUT_3_1>(in, img_input);
      hls::stream<result_t> layer17_out("layer17_out");

            // hls-fpga-machine-learning insert top-level-function
            myproject(img_input,layer17_out);
        ...
        for (unsigned i = 0; i < NUM_TEST_SAMPLES; i++) {
            ...
            hls::stream<input_t> img_input("img_input");
            nnet::fill_zero<input_t, N_INPUT_1_1*N_INPUT_2_1*N_INPUT_3_1>(img_input);
            hls::stream<result_t> layer17_out("layer17_out");
