...
entity myproject_fifo_w152_d16_A is
    generic (
        MEM_STYLE         : string  := "auto";
        DATA_WIDTH        : integer := 152;
...
architecture arch of myproject_fifo_w152_d16_A is

    -- component
    component myproject_fifo_w152_d16_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
        DATA_WIDTH : natural := 152;
...
begin
----------------------- Instantiation -----------------------
    U_myproject_fifo_w152_d16_A_ram : myproject_fifo_w152_d16_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity myproject_fifo_w152_d16_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 152;
        ADDR_WIDTH  : integer := 4;
...
architecture arch of myproject_fifo_w152_d16_A_ram is
