...
set C_modelArgList {
	{ layer13_out int 1120 regular {fifo 0 volatile }  }
	{ layer14_out int 192 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "layer13_out", "interface" : "fifo", "bitwidth" : 1120, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer13_out_dout sc_in sc_lv 1120 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer13_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1120, "type": "signal", "bundle":{"name": "layer13_out", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	layer13_out { ap_fifo {  { layer13_out_dout fifo_port_we 0 1120 }  { layer13_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer13_out_fifo_cap fifo_update 0 2 }  { layer13_out_empty_n fifo_status 0 1 }  { layer13_out_read fifo_data 1 1 } } }
	layer14_out { ap_fifo {  { layer14_out_din fifo_port_we 1 192 }  { layer14_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer14_out_fifo_cap fifo_update 0 2 }  { layer14_out_full_n fifo_status 0 1 }  { layer14_out_write fifo_data 1 1 } } }
}
