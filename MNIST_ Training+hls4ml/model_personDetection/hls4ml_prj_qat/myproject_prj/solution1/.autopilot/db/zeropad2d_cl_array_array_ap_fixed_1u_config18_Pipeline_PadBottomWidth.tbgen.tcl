set moduleName zeropad2d_cl_array_array_ap_fixed_1u_config18_Pipeline_PadBottomWidth
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {zeropad2d_cl<array,array<ap_fixed,1u>,config18>_Pipeline_PadBottomWidth}
