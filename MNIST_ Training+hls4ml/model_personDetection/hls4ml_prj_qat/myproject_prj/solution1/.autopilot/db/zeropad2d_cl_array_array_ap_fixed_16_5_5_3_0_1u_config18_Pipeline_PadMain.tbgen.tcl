set moduleName zeropad2d_cl_array_array_ap_fixed_16_5_5_3_0_1u_config18_Pipeline_PadMain
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {zeropad2d_cl<array,array<ap_fixed<16,5,5,3,0>,1u>,config18>_Pipeline_PadMain}
...
set portList { 
	...
	{ layer18_out_din sc_out sc_lv 16 signal 0 } 
	{ layer18_out_num_data_valid sc_in sc_lv 8 signal 0 } 
	{ layer18_out_fifo_cap sc_in sc_lv 8 signal 0 } 
	{ layer18_out_full_n sc_in sc_logic 1 signal 0 } 
	{ layer18_out_write sc_out sc_logic 1 signal 0 } 
	{ img_input_TDATA sc_in sc_lv 16 signal 1 } 
	{ img_input_TVALID sc_in sc_logic 1 invld 1 } 
	{ img_input_TREADY sc_out sc_logic 1 inacc 1 } 
}
set NewPortList {[ 
