set moduleName linear_array_array_ap_fixed_16_5_5_3_0_10u_linear_config16_s
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {linear<array,array<ap_fixed<16,5,5,3,0>,10u>,linear_config16>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer15_out int 160 regular {fifo 0 volatile }  }
	{ layer16_out int 160 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "layer15_out", "interface" : "fifo", "bitwidth" : 160, "direction" : "READONLY"} , 
 	{ "Name" : "layer16_out", "interface" : "fifo", "bitwidth" : 160, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer16_out_din sc_out sc_lv 160 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer16_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":160, "type": "signal", "bundle":{"name": "layer16_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	layer15_out { ap_fifo {  { layer15_out_dout fifo_port_we 0 160 }  { layer15_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer15_out_fifo_cap fifo_update 0 2 }  { layer15_out_empty_n fifo_status 0 1 }  { layer15_out_read fifo_data 1 1 } } }
	layer16_out { ap_fifo {  { layer16_out_din fifo_port_we 1 160 }  { layer16_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer16_out_fifo_cap fifo_update 0 2 }  { layer16_out_full_n fifo_status 0 1 }  { layer16_out_write fifo_data 1 1 } } }
}
