...
set C_modelArgList {
	{ layer2_out int 108 regular {fifo 0 volatile }  }
	{ layer4_out int 24 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "layer2_out", "interface" : "fifo", "bitwidth" : 108, "direction" : "READONLY"} , 
 	{ "Name" : "layer4_out", "interface" : "fifo", "bitwidth" : 24, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer2_out_dout sc_in sc_lv 108 signal 0 } 
	{ layer2_out_num_data_valid sc_in sc_lv 7 signal 0 } 
	{ layer2_out_fifo_cap sc_in sc_lv 7 signal 0 } 
	{ layer2_out_empty_n sc_in sc_logic 1 signal 0 } 
	{ layer2_out_read sc_out sc_logic 1 signal 0 } 
	{ layer4_out_din sc_out sc_lv 24 signal 1 } 
	{ layer4_out_num_data_valid sc_in sc_lv 7 signal 1 } 
	{ layer4_out_fifo_cap sc_in sc_lv 7 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer2_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":108, "type": "signal", "bundle":{"name": "layer2_out", "role": "dout" }} , 
 	...
 	{ "name": "layer4_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "layer4_out", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "layer2_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "layer2_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "layer4_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	layer2_out { ap_fifo {  { layer2_out_dout fifo_port_we 0 108 }  { layer2_out_num_data_valid fifo_status_num_data_valid 0 7 }  { layer2_out_fifo_cap fifo_update 0 7 }  { layer2_out_empty_n fifo_status 0 1 }  { layer2_out_read fifo_data 1 1 } } }
	layer4_out { ap_fifo {  { layer4_out_din fifo_port_we 1 24 }  { layer4_out_num_data_valid fifo_status_num_data_valid 0 7 }  { layer4_out_fifo_cap fifo_update 0 7 }  { layer4_out_full_n fifo_status 0 1 }  { layer4_out_write fifo_data 1 1 } } }
}
