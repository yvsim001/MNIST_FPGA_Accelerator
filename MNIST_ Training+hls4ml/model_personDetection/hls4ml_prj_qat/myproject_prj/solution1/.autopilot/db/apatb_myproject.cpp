...
// wrapc file define:
#define AUTOTB_TVIN_img_input "../tv/cdatafile/c.myproject.autotvin_img_input.dat"
#define WRAPC_STREAM_SIZE_IN_img_input "../tv/stream_size/stream_size_in_img_input.dat"
#define WRAPC_STREAM_INGRESS_STATUS_img_input "../tv/stream_size/stream_ingress_status_img_input.dat"
...
extern "C"
void apatb_myproject_hw(void* __xlx_apatb_param_img_input, void* __xlx_apatb_param_layer17_out)
{
  static hls::sim::Stream<hls::sim::Byte<2>> port0 {
    .width = 16,
    .name = "img_input",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_img_input),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_img_input),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_img_input),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_img_input),
#endif
  };
  port0.param = (hls::stream<hls::sim::Byte<2>>*)__xlx_apatb_param_img_input;
  ...
  port1.param = (hls::stream<hls::sim::Byte<20>>*)__xlx_apatb_param_layer17_out;
  port1.hasWrite = true;
  ...
  try {
    ...
    myproject_hw_stub_wrapper(__xlx_apatb_param_img_input, __xlx_apatb_param_layer17_out);
    port1.buffer();
