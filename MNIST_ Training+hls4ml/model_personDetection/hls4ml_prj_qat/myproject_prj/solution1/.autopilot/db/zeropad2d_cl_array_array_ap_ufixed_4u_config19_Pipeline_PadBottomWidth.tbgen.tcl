set moduleName zeropad2d_cl_array_array_ap_ufixed_4u_config19_Pipeline_PadBottomWidth
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {zeropad2d_cl<array,array<ap_ufixed,4u>,config19>_Pipeline_PadBottomWidth}
