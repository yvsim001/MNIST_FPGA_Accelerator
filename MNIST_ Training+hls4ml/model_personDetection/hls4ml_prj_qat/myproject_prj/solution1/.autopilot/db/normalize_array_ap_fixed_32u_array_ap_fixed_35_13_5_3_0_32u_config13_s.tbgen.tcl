set moduleName normalize_array_ap_fixed_32u_array_ap_fixed_35_13_5_3_0_32u_config13_s
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {normalize<array<ap_fixed,32u>,array<ap_fixed<35,13,5,3,0>,32u>,config13>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer11_out int 576 regular {fifo 0 volatile }  }
	{ layer13_out int 1120 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "layer11_out", "interface" : "fifo", "bitwidth" : 576, "direction" : "READONLY"} , 
 	{ "Name" : "layer13_out", "interface" : "fifo", "bitwidth" : 1120, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer11_out_dout sc_in sc_lv 576 signal 0 } 
	...
	{ layer13_out_din sc_out sc_lv 1120 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer11_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":576, "type": "signal", "bundle":{"name": "layer11_out", "role": "dout" }} , 
 	...
 	{ "name": "layer13_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1120, "type": "signal", "bundle":{"name": "layer13_out", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_18s_16ns_33_2_1_U350", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_18s_16ns_33_2_1_U351", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	layer11_out { ap_fifo {  { layer11_out_dout fifo_port_we 0 576 }  { layer11_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer11_out_fifo_cap fifo_update 0 2 }  { layer11_out_empty_n fifo_status 0 1 }  { layer11_out_read fifo_data 1 1 } } }
	layer13_out { ap_fifo {  { layer13_out_din fifo_port_we 1 1120 }  { layer13_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer13_out_fifo_cap fifo_update 0 2 }  { layer13_out_full_n fifo_status 0 1 }  { layer13_out_write fifo_data 1 1 } } }
}
